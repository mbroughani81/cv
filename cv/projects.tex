...
%---------------------------------------------------------
  ...
  % }
  \cventry
  {University Course} % Organisation
  {Operating Systems Exercises} % Project
  {Tehran, Iran} % Location
  {Sep 2024 - Jan 2025} % Date(s)
  {
    \begin{cvitems} % Description(s) of project
    \item {Link: \href{https://github.com/mbroughani81/os-course}{\textit{https://github.com/mbroughani81/os-course}}}
    \item{
        This repository contains exercises from my Operating Systems course,
        implemented in KPL programming language. It includes low-level
        concurrency constructs like mutexes and condition, and a
        kernel program capable of loading and executing user programs. The
        exercises cover process management, memory management, file systems and concurrency.
      }
